...
for i in range(len(lon_stn)):
    ...
    plt.subplot(2, 2, 1)
    plt.plot(time_filtered, elevation, label=f"Elevation at {stn_name[i]}")
    ...
    plt.subplot(2, 2, 2)
    plt.plot(time_filtered, u, label=f"U velocity at {stn_name[i]}")
    ...
    plt.subplot(2, 2, 3)
    plt.plot(time_filtered, v, label=f"V velocity at {stn_name[i]}")
    ...
    plt.subplot(2, 2, 4)
    plt.plot(time_filtered, direction, label=f"Direction at {stn_name[i]}")
